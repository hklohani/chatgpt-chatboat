...
const ChatList = () => {
  return (
    <div className=" flex flex-col gap-8  mb-6 overflow-y-auto custom-scrolbar">
      <div className="border bg-white flex w-full justify-center p-4">
        <div className="w-1/2 flex gap-4 self-center  justify-center">
          <img
            className="w-12 h-12 rounded"
            src="https://images.pexels.com/photos/5774804/pexels-photo-5774804.jpeg?auto=compress&cs=tinysrgb&w=1600"
            alt="Default avatar"
          />
